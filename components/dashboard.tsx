...
export function Dashboard({ user, onLogout }: DashboardProps) {
  ...
  const achievements = [
    ...
    { id: 3, name: "Streak Master", description: "Maintain a 7-day streak", icon: Fire, earned: userStats.streak >= 7 },
    { id: 4, name: "Algorithm Expert", description: "Master all sorting algorithms", icon: Target, earned: false },
    {
      ...
      icon: Award,
      earned: userStats.challengesCompleted >= 50,
    },
  ]
  ...
  const challenges = [
    {
      ...
      difficulty: "Easy",
      xp: 50,
      completed: userStats.challengesCompleted > 0,
    ...
    },
    {
      ...
      difficulty: "Medium",
      xp: 100,
      completed: userStats.challengesCompleted > 5,
            ...
            <Card className="bg-gradient-to-r from-purple-500 to-blue-600 text-white">
              <CardHeader>
                ...
                <CardDescription className="text-purple-100">
                  Ready to continue your coding adventure? You're doing great!
                </CardDescription>
              </CardHeader>
            </Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {[
                    ...
                    <div
                      key={leaderUser.rank}
                      className={`flex items-center gap-4 p-3 rounded-lg ${leaderUser.isUser ? "bg-blue-50 border border-blue-200" : "hover:bg-gray-50"}`}
                    >
                      <div
                      ...
                      <Avatar>
                        <AvatarFallback>{leaderUser.avatar}</AvatarFallback>
                      </Avatar>
                      <div className="flex-1">
                        <div className="font-medium">{leaderUser.name}</div>
                        <div className="text-sm text-gray-600">{leaderUser.xp.toLocaleString()} XP</div>
                      </div>
                      {leaderUser.rank <= 3 && (
                        <Trophy
                          className={`w-5 h-5 ${
